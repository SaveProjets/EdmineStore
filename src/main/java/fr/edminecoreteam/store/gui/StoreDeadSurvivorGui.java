...
public class StoreDeadSurvivorGui implements Listener 
{
        ...
        if (settingInfo.getLang() == 0)
        {
            ...
            new BukkitRunnable() {
    	        ...
    	        public void run() {
	                ...
	                loredeadsurvivor1.add(" §f  §7sur les skins dead survivor.");
	                loredeadsurvivor1.add("");
