...
public class StoreBoosterGui implements Listener 
{
        ...
        if (settingInfo.getLang() == 0)
        {
            ...
            new BukkitRunnable() {
    	        ...
    	        public void run() {
	                ...
	                ItemStack boosters = getSkull("http://textures.minecraft.net/texture/d4c4a254bec46e274757c07979f0ddae36c7b365487c8f35ffead4cb2e311b9");
                    ...
                    for (int articles : getArticleListByType("boosters", "enable")) {
                    	++articlesCount;
